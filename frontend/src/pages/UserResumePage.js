  ...
  return (
    <>
      ...
      <div className={`min-h-screen font-sans transition-colors duration-500 print:hidden ${isDarkMode ? 'bg-[#09090b]' : 'bg-[#f4f4f5]'}`}>
        ...
        <main className={`pt-20 md:pt-24 pb-12 md:pb-20 px-4 flex flex-col items-center justify-start min-h-screen relative z-10 ${focusedPage ? 'overflow-hidden' : ''}`}>
          {focusedPage && (
            <div className="fixed inset-0 z-[150] pointer-events-none flex flex-col items-center justify-between p-6 animate-fade-in">
          ...
          {!focusedPage && (
            <div className={`mt-20 text-center animate-bounce opacity-40 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
